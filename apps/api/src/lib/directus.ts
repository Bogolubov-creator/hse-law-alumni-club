...
export interface AlumniRow {
  ...
  personal_discount: number; contacts_json: Record<string, string> | null;
...
export interface ProgramRow {
  ...
  price: number; dates: unknown; modules: unknown; teachers: unknown; description: string | null; status: string;
}
