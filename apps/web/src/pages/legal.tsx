...
export function Privacy({ v2 }: { v2?: boolean } = {}) {
  return (
    <LegalShell title="Политика обработки персональных данных" updated="8 сентября 2026 года" v2={v2}>
      <p>
      ...
      <h2>6. Cookies</h2>
      <p>
        Для корзины, сессии входа и выбранных настроек используются cookies и локальное хранилище браузера.
        Закрытие уведомления не заменяет отдельного согласия на обработку данных в формах.
