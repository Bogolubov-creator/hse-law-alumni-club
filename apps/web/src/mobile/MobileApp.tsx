...
// ── Лента (новости) ──────────────────────────────────────────────────
const NEWS_TINTS = ["#2C6E80", "#11296B", "#C24009", "#7A5CA8", "#1F8A5B"];
function MobileFeed() {
  useHead({ title: "Новости клуба", description: "Новости клуба выпускников факультета права Вышки." });
...
function MobilePodcasts() {
  useHead({ title: "Подкасты клуба", description: "Подкасты клуба выпускников факультета права Вышки." });
...
// ── Мерч ─────────────────────────────────────────────────────────────
const MERCH_TINTS = ["#C24009", "#2C6E80", "#11296B", "#7A5CA8"];
            ...
            <div style={{ padding: "11px 13px 13px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 8 }}>
                ...
                <button aria-label={m.variants_json?.length ? `Выбрать размер «${m.title}»` : `Добавить «${m.title}» в корзину`}
                  ...
                  style={{ width: 32, height: 32, borderRadius: 10, border: "none", background: "#EC5A13", color: "#14181F", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
